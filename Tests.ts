...
console.log("\n")
console.log("Test 4")
console.log((new Evaluator()).evaluate("fn f (a : int) -> int {return a + 1;} f(3);"))
console.log("\n")
console.log("Test 4.1")
console.log((new Evaluator()).evaluate("fn f (a : int) -> undefined {1;return undefined;} f(3);"))
console.log("\n")
console.log("Test 4.2")
console.log((new Evaluator()).evaluate("fn f () -> undefined {1;return undefined;} f();"))
console.log("\n")
console.log("Test 4.3")
console.log((new Evaluator()).evaluate("fn f (a : int, b : int) -> int {1;return a + b;} f(1, 2);"))
console.log("\n")
console.log("Test 5")
