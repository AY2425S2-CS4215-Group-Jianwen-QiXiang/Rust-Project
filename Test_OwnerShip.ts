...
console.log("\n")
console.log("Test 9")
console.log(new Evaluator().evaluate("fn foo(x : int) -> int {return x+2;} let mut y : int = 10; foo(y);"))
console.log("\n")
console.log("Test 10")
console.log(new Evaluator().evaluate(`fn foo(x : *mut string) -> *mut string {*x; return x;} let mut y : string = "hello"; foo(&mut y);`))
console.log("\n")
console.log("Test 11")
console.log(new Evaluator().evaluate(`fn foo(x : *mut string) -> *mut string {*x; return x;} let mut y : string = "hello"; let z : *mut string = &mut y; foo(&y);`))
console.log("\n")
console.log("Test 12")
console.log(new Evaluator().evaluate(`fn foo() -> *mut string {let z : *mut string = &mut y; return z;} let mut y : string = "hello"; let a : *mut string = foo(); *a;`))
console.log(new Evaluator().evaluate(`fn foo() -> *mut string {let z : *mut string = &mut y; return z;} let mut y : string = "hello"; let x : *mut string = &mut y; foo();`))
